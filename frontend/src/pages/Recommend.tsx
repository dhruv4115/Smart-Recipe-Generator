...
const handleGenerateRecipe = async () => {
  ...
  try {
    ...
    console.log('AI generated recipe from backend:', recipe);
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-2">
                ...
                />
                <Button onClick={handleAddIngredient} size="sm">Add</Button>
              </div>
            </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {generatedRecipe && (
            <Card className="border-primary/40 bg-primary/5">
              ...
              <CardContent>
                <RecipeCard recipe={generatedRecipe} onFavorite={handleFavorite} />
              </CardContent>
            </Card>
          )}
                    ...
                    <Card className="bg-muted/50">
                      <CardContent className="pt-4 pb-3">
                        <div className="grid grid-cols-2 gap-2 text-xs">
                          <div><span className="text-muted-foreground">Match:</span> <span className="font-semibold">{(item.scores.overlap * 100).toFixed(0)}%</span></div>
                          <div><span className="text-muted-foreground">Semantic:</span> <span className="font-semibold">{(item.scores.semantic * 100).toFixed(0)}%</span></div>
                          <div><span className="text-muted-foreground">Popularity:</span> <span className="font-semibold">{(item.scores.popularity * 100).toFixed(0)}%</span></div>
                          <div><span className="text-muted-foreground">Overall:</span> <span className="font-semibold">{(item.scores.combined * 100).toFixed(0)}%</span></div>
                        </div>
